...
function cursor(e) {
    ...
    const isHoveringNav = e.target === nav || nav.contains(e.target);
    const isHoveringBtn = e.target === btn || btn.contains(e.target);

    if (isHoveringNav) {
        mouseCursor.innerHTML = paw;
    } else if (isHoveringBtn) {
        mouseCursor.innerHTML = bread;
    } else {
        mouseCursor.innerHTML = restartgame;
    }
}